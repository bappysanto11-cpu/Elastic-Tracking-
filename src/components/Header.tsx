...
Total Length: ${summary.totalMtr} Mtr (${summary.totalGry} Gry / ${summary.totalYds} Yds)`;
  ...
  if (isCollapsed) {
    return (
      <header className="bg-slate-950/80 backdrop-blur-2xl text-white sticky top-0 z-40 shadow-[0_4px_30px_rgba(0,0,0,0.5)] border-b border-white/[0.08] print:hidden">
